...
opt_adam = keras.optimizers.Adam(lr=0.0015, beta_1=0.9, beta_2=0.999, epsilon=None, decay=0.005, amsgrad=False)
...
f = open('images/run10/output_Adam.txt','w')
...
#pp.savefig()
plt.savefig('images/run10/YpredvsYactual_Simpler_Adam.png')
#fig1.show()
...
plt.title("Predicted vs Actual Yield for Validation Set")
#pp.savefig()
plt.savefig('images/run10/YpredvsYactual_Scatter_Adam.png')
...
#pp.savefig()
plt.savefig('images/run10/YpredvsYactualtrain_Scatter_Adam.png')
...
# plt.ylim( 0, 300 )
#pp.savefig()
plt.savefig('images/run10/MAPE_simpler_Adam.png')
...
#pp.savefig()
plt.savefig('images/run10/RMSE_simpler_Adam.png')
#plt.ylim(0,2)
...
#pp.savefig()
plt.savefig('images/run10/Loss_history_training_Adam.png')
