...
X_train = X_shuffled[0:1200, : ,12:33, :]
Y_train = Y_shuffled[0:1200].reshape(1200, 1)

X_val = X_shuffled[1200:1338, : ,12:33, :]
Y_val = Y_shuffled[1200:1338].reshape(138, 1)

X_test = X_shuffled[1339:1477, : ,12:33, :]
...
batch_size = 25
epochs = 120
img_rows, img_cols, channels = 32, 20, 9  # input image dimensions
...
#Compared to run 11
#Increased decay from 0.005 to 0.008
#Decreased learning rate to 0.0007
...
opt_adam = keras.optimizers.Adam(lr=0.0007, beta_1=0.9, beta_2=0.999, epsilon=None, decay=0.008, amsgrad=False)
...
f = open('images/run12/output_Adam.txt','w')
...
model.save('images/run12/Keras_CNN_gcs_adam12.h5')
'''
...
#pp.savefig()
plt.savefig('images/run12/YpredvsYactual_Simpler_Adam.png')
#fig1.show()
...
plt.title("Predicted vs Actual Yield for Validation Set")
#pp.savefig()
plt.savefig('images/run12/YpredvsYactual_Scatter_Adam.png')
...
#pp.savefig()
plt.savefig('images/run12/YpredvsYactualtrain_Scatter_Adam.png')
...
# plt.ylim( 0, 300 )
#pp.savefig()
plt.savefig('images/run12/MAPE_simpler_Adam.png')
...
#pp.savefig()
plt.savefig('images/run12/RMSE_simpler_Adam.png')
#plt.ylim(0,2)
