...
f = open('images/output_Adam3.txt','w')
...
#pp.savefig()
plt.savefig('images/YpredvsYactual_Simpler_Adam3.png')
#fig1.show()
...
plt.title("Predicted vs Actual Yield for Validation Set")
#pp.savefig()
plt.savefig('images/YpredvsYactual_Scatter_Adam3.png')
...
# plt.ylim( 0, 300 )
#pp.savefig()
plt.savefig('images/MAPE_simpler_Adam3.png')
...
#pp.savefig()
plt.savefig('images/RMSE_simpler_Adam3.png')
#plt.ylim(0,2)
...
#pp.savefig()
plt.savefig('Loss_history_training_Adam3.png')
