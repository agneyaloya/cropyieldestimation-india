...
opt_adam = keras.optimizers.Adam(lr=0.001, beta_1=0.9, beta_2=0.999, epsilon=None, decay=0.001, amsgrad=False)
...
f = open('images/run9/output_Adam.txt','w')
...
#pp.savefig()
plt.savefig('images/run9/YpredvsYactual_Simpler_Adam.png')
#fig1.show()
...
plt.title("Predicted vs Actual Yield for Validation Set")
#pp.savefig()
plt.savefig('images/run9/YpredvsYactual_Scatter_Adam.png')
...
#pp.savefig()
plt.savefig('images/run9/YpredvsYactualtrain_Scatter_Adam.png')
...
# plt.ylim( 0, 300 )
#pp.savefig()
plt.savefig('images/run9/MAPE_simpler_Adam.png')
...
#pp.savefig()
plt.savefig('images/run9/RMSE_simpler_Adam.png')
#plt.ylim(0,2)
...
#pp.savefig()
plt.savefig('images/run9/Loss_history_training_Adam.png')
