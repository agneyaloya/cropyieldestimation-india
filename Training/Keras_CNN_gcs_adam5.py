...
f = open('images/run5/output_Adam.txt','w')
...
#pp.savefig()
plt.savefig('images/run5/YpredvsYactual_Simpler_Adam.png')
#fig1.show()
...
plt.title("Predicted vs Actual Yield for Validation Set")
#pp.savefig()
plt.savefig('images/run5/YpredvsYactual_Scatter_Adam.png')
...
# plt.ylim( 0, 300 )
#pp.savefig()
plt.savefig('images/run5/MAPE_simpler_Adam.png')
...
#pp.savefig()
plt.savefig('images/run5/RMSE_simpler_Adam.png')
#plt.ylim(0,2)
...
#pp.savefig()
plt.savefig('images/run5/Loss_history_training_Adam.png')
