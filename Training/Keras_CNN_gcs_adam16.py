...
f = open('images/run16/output_Adam.txt','w')
...
model.save('images/run16/Keras_CNN_gcs_adam16.h5')
'''
...
#pp.savefig()
plt.savefig('images/run16/YpredvsYactual_Simpler_Adam.png')
#fig1.show()
...
plt.title("Predicted vs Actual Yield for Validation Set")
#pp.savefig()
plt.savefig('images/run16/YpredvsYactual_Scatter_Adam.png')
...
#pp.savefig()
plt.savefig('images/run16/YpredvsYactualtrain_Scatter_Adam.png')
...
# plt.ylim( 0, 300 )
#pp.savefig()
plt.savefig('images/run16/MAPE_simpler_Adam.png')
...
#pp.savefig()
plt.savefig('images/run16/RMSE_simpler_Adam.png')
#plt.ylim(0,2)
