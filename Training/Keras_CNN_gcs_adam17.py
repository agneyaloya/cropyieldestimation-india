...
f = open('images/run17/output_Adam.txt','w')
...
model.save('images/run17/Keras_CNN_gcs_adam17.h5')
'''
...
#pp.savefig()
plt.savefig('images/run17/YpredvsYactual_Simpler_Adam.png')
#fig1.show()
...
plt.title("Predicted vs Actual Yield for Validation Set")
#pp.savefig()
plt.savefig('images/run17/YpredvsYactual_Scatter_Adam.png')
...
#pp.savefig()
plt.savefig('images/run17/YpredvsYactualtrain_Scatter_Adam.png')
...
# plt.ylim( 0, 300 )
#pp.savefig()
plt.savefig('images/run17/MAPE_simpler_Adam.png')
...
#pp.savefig()
plt.savefig('images/run17/RMSE_simpler_Adam.png')
#plt.ylim(0,2)
