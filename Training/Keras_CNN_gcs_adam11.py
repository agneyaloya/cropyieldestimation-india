...
f = open('images/run11/output_Adam.txt','w')
...
model.save('images/run11/Keras_CNN_gcs_adam11.h5')
'''
...
#pp.savefig()
plt.savefig('images/run11/YpredvsYactual_Simpler_Adam.png')
#fig1.show()
...
plt.title("Predicted vs Actual Yield for Validation Set")
#pp.savefig()
plt.savefig('images/run11/YpredvsYactual_Scatter_Adam.png')
...
#pp.savefig()
plt.savefig('images/run11/YpredvsYactualtrain_Scatter_Adam.png')
...
# plt.ylim( 0, 300 )
#pp.savefig()
plt.savefig('images/run11/MAPE_simpler_Adam.png')
...
#pp.savefig()
plt.savefig('images/run11/RMSE_simpler_Adam.png')
#plt.ylim(0,2)
