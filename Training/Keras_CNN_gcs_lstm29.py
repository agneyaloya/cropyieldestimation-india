...
history = model.fit(X_train, Y_train, batch_size=batch_size, epochs=epochs, verbose=1, validation_data=(X_val, Y_val), callbacks=[early_stop])
...
f = open('images/run29/output_Adam.txt','w')
...
model.save('images/run29/Keras_CNN_gcs_adam_run29.h5')
...
#pp.savefig()
plt.savefig('images/run29/YpredvsYactual_Simpler_Adam.png')
#fig1.show()
...
plt.title("Predicted vs Actual Yield for Validation Set")
#pp.savefig()
plt.savefig('images/run29/YpredvsYactual_Scatter_Adam.png')
...
#pp.savefig()
plt.savefig('images/run29/YpredvsYactualtrain_Scatter_Adam.png')
...
# plt.ylim( 0, 300 )
#pp.savefig()
plt.savefig('images/run29/MAPE_simpler_Adam.png')
...
#pp.savefig()
plt.savefig('images/run29/RMSE_simpler_Adam.png')
#plt.ylim(0,2)
