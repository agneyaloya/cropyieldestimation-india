...
f = open('images/run26/output_Adam.txt','w')
...
model.save('images/run26/Keras_CNN_gcs_adam_run26.h5')
...
#pp.savefig()
plt.savefig('images/run26/YpredvsYactual_Simpler_Adam.png')
#fig1.show()
...
plt.title("Predicted vs Actual Yield for Validation Set")
#pp.savefig()
plt.savefig('images/run26/YpredvsYactual_Scatter_Adam.png')
...
#pp.savefig()
plt.savefig('images/run26/YpredvsYactualtrain_Scatter_Adam.png')
...
# plt.ylim( 0, 300 )
#pp.savefig()
plt.savefig('images/run26/MAPE_simpler_Adam.png')
...
#pp.savefig()
plt.savefig('images/run26/RMSE_simpler_Adam.png')
#plt.ylim(0,2)
