...
opt_adam = keras.optimizers.Adam(lr=0.0005, beta_1=0.9, beta_2=0.999, epsilon=None, decay=0.005, amsgrad=False)
...
f = open('images/run31/output_Adam.txt','w')
...
model.save('images/run31/Keras_CNN_gcs_adam_run31.h5')
...
#pp.savefig()
plt.savefig('images/run31/YpredvsYactual_Simpler_Adam.png')
#fig1.show()
...
plt.title("Predicted vs Actual Yield for Validation Set")
#pp.savefig()
plt.savefig('images/run31/YpredvsYactual_Scatter_Adam.png')
...
#pp.savefig()
plt.savefig('images/run31/YpredvsYactualtrain_Scatter_Adam.png')
...
# plt.ylim( 0, 300 )
#pp.savefig()
plt.savefig('images/run31/MAPE_simpler_Adam.png')
...
#pp.savefig()
plt.savefig('images/run31/RMSE_simpler_Adam.png')
#plt.ylim(0,2)
