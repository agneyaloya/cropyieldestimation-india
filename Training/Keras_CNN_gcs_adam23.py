...
opt_adam = keras.optimizers.Adam(lr=0.0003, beta_1=0.9, beta_2=0.999, epsilon=None, decay=0.005, amsgrad=False)
...
f = open('images/run23/output_Adam.txt','w')
...
model.save('images/run23/Keras_CNN_gcs_adam_run23.h5')
'''
...
#pp.savefig()
plt.savefig('images/run23/YpredvsYactual_Simpler_Adam.png')
#fig1.show()
...
plt.title("Predicted vs Actual Yield for Validation Set")
#pp.savefig()
plt.savefig('images/run23/YpredvsYactual_Scatter_Adam.png')
...
#pp.savefig()
plt.savefig('images/run23/YpredvsYactualtrain_Scatter_Adam.png')
...
# plt.ylim( 0, 300 )
#pp.savefig()
plt.savefig('images/run23/MAPE_simpler_Adam.png')
...
#pp.savefig()
plt.savefig('images/run23/RMSE_simpler_Adam.png')
#plt.ylim(0,2)
