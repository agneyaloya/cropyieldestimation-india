...
X_train = X_shuffled[0:1099, : ,:, 3:9]
Y_train = Y_shuffled[0:1099].reshape(1099, 1)

X_val = X_shuffled[1099:1211, : ,:, 3:9]
Y_val = Y_shuffled[1099:1211].reshape(112, 1)

X_test = X_shuffled[1211:1318, : ,:, 3:9]
...
f = open('images/run25/output_Adam.txt','w')
...
model.save('images/run25/Keras_CNN_gcs_adam_run25.h5')
...
#pp.savefig()
plt.savefig('images/run25/YpredvsYactual_Simpler_Adam.png')
#fig1.show()
...
plt.title("Predicted vs Actual Yield for Validation Set")
#pp.savefig()
plt.savefig('images/run25/YpredvsYactual_Scatter_Adam.png')
...
#pp.savefig()
plt.savefig('images/run25/YpredvsYactualtrain_Scatter_Adam.png')
...
# plt.ylim( 0, 300 )
#pp.savefig()
plt.savefig('images/run25/MAPE_simpler_Adam.png')
...
#pp.savefig()
plt.savefig('images/run25/RMSE_simpler_Adam.png')
#plt.ylim(0,2)
