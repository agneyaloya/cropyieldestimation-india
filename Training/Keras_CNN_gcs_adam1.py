...
pp = PdfPages('output_images_Adam1.pdf')
...
pp.savefig()
plt.savefig('YpredvsYactual_Simpler_Adam1.png')
#fig1.show()
...
plt.savefig('MAPE_simpler_Adam1.png')
...
pp.savefig()
plt.savefig('RMSE_simpler_Adam1.png')
#plt.ylim(0,2)
...
pp.savefig()
plt.savefig('Loss_history_training_Adam1.png')
