...
#Compared to run 13
#Run13 was very good on training, overfitting
#Reduced maxpooling, replaced with dropout
#Epochs to 300
...
f = open('images/run14/output_Adam.txt','w')
...
model.save('images/run14/Keras_CNN_gcs_adam14.h5')
'''
...
#pp.savefig()
plt.savefig('images/run14/YpredvsYactual_Simpler_Adam.png')
#fig1.show()
...
plt.title("Predicted vs Actual Yield for Validation Set")
#pp.savefig()
plt.savefig('images/run14/YpredvsYactual_Scatter_Adam.png')
...
#pp.savefig()
plt.savefig('images/run14/YpredvsYactualtrain_Scatter_Adam.png')
...
# plt.ylim( 0, 300 )
#pp.savefig()
plt.savefig('images/run14/MAPE_simpler_Adam.png')
...
#pp.savefig()
plt.savefig('images/run14/RMSE_simpler_Adam.png')
#plt.ylim(0,2)
