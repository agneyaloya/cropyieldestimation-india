...
f = open('images/run4/output_Adam4.txt','w')
...
#pp.savefig()
plt.savefig('images/run4/YpredvsYactual_Simpler_Adam4.png')
#fig1.show()
...
plt.title("Predicted vs Actual Yield for Validation Set")
#pp.savefig()
plt.savefig('images/run4/YpredvsYactual_Scatter_Adam4.png')
...
# plt.ylim( 0, 300 )
#pp.savefig()
plt.savefig('images/run4/MAPE_simpler_Adam4.png')
...
#pp.savefig()
plt.savefig('images/run4/RMSE_simpler_Adam4.png')
#plt.ylim(0,2)
...
#pp.savefig()
plt.savefig('images/run4/Loss_history_training_Adam4.png')
