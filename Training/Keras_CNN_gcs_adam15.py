...
#Compared to run 8 same, just seed
...
f = open('images/run15/output_Adam.txt','w')
...
model.save('images/run15/Keras_CNN_gcs_adam15.h5')
'''
...
#pp.savefig()
plt.savefig('images/run15/YpredvsYactual_Simpler_Adam.png')
#fig1.show()
...
plt.title("Predicted vs Actual Yield for Validation Set")
#pp.savefig()
plt.savefig('images/run15/YpredvsYactual_Scatter_Adam.png')
...
#pp.savefig()
plt.savefig('images/run15/YpredvsYactualtrain_Scatter_Adam.png')
...
# plt.ylim( 0, 300 )
#pp.savefig()
plt.savefig('images/run15/MAPE_simpler_Adam.png')
...
#pp.savefig()
plt.savefig('images/run15/RMSE_simpler_Adam.png')
#plt.ylim(0,2)
